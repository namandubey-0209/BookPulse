...
export const forgotPassword = async (req, res) => {
    try {
        ...
        // Send reset email (optional - comment out if not needed)
        // try {
        //     await sendEmail({
        //         to: email,
        //         subject: 'Password Reset - BookTracker',
...
export const resendVerificationEmail = async (req, res) => {
    try {
        ...
        // Send verification email (optional - comment out if not needed)
        // try {
        //     await sendEmail({
        //         to: user.email,
        //         subject: 'Verify Your Email - BookTracker',
