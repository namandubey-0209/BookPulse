...
export const getReviews = async (req, res) => {
    try {
        ...
        const reviews = await Discussion.find(query)
...
export const updateReview = async (req, res) => {
    try {
        ...
        const review = await Discussion.findOne({
            _id: req.params.id,
            user: req.user.id
        });
...
export const deleteReview = async (req, res) => {
    try {
        const review = await Discussion.findOneAndDelete({
            _id: req.params.id,
            user: req.user.id
        });
...
export const toggleLike = async (req, res) => {
    try {
        const review = await Discussion.findById(req.params.id);
